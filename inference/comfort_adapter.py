...
from core.config import COMFORT_GAMES_THRESHOLD
...
def _games_to_comfort(games_played: int) -> float:
    ...
    Uses a linear scale from 0 to COMFORT_GAMES_THRESHOLD+ games:
    - COMFORT_GAMES_THRESHOLD+ games: 1.0 (from games alone)
    - 0 games: 0.0
    - Linear interpolation in between
    """
    return games_played / COMFORT_GAMES_THRESHOLD
