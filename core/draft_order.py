...
NOTE: This module is duplicated in draft/draft_order.py for the active inference path.
Both modules contain identical DRAFT_SEQUENCE and helper functions. They are kept
separate to maintain clear boundaries between ML training code (core/) and active
inference code (draft/). If consolidating, ensure both code paths are updated.
"""
